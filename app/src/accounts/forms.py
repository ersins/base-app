...
class UserDetailChangeForm(forms.ModelForm):
    ...
    surname = forms.CharField(label='Surname', required=False, widget=forms.TextInput(attrs={"class": 'form-control'}))
...
class UserAdminChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = User
        fields = ('name', 'surname', 'email', 'password', 'is_active', 'admin', 'staff')
