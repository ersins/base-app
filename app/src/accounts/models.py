...
class UserManager(BaseUserManager):
    def create_user(self, email, name, surname, password=None, is_active=False, is_staff=False, is_admin=False):
        if not email:
...
class User(AbstractBaseUser):
    ...
    REQUIRED_FIELDS = ['name', 'surname']  # ['full_name'] #python manage.py createsuperuser
